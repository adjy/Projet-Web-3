...
(9, 'Filet mignon de porc caramélisé à la sauce soja - Les Délices Légers de Zabou', 'Filet_mignon_de_porc.jpg','Le filet mignon de porc caramélisé à la sauce soja est un plat délicieux et facile à préparer proposé par Les Délices Légers de Zabou. Il s\'agit d\'un plat asiatique qui marie des saveurs sucrées et salées.
...
(14, 'Bavarois Poire, Sablé breton et Sauce caramel onctueuse', 'Bavarois-Poire.jpg','Le bavarois poire est un dessert frais et léger, qui combine une mousse à la poire, un sablé breton croustillant et une sauce caramel onctueuse. Pour préparer cette recette, on commence par préparer la mousse à la poire en mixant des poires en purée dans un blender. On ajoute ensuite du sucre, de la gélatine ramollie et de la crème fouettée dans le blender et on mixe le tout jusqu\'à obtenir une texture légère et mousseuse.
